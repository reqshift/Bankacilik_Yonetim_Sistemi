...
public abstract class Account {
    ...
    public Account(String accountNo, String customerName, NotificationService notificationService){ //constructor used to access first parameters
    ...
    //methods
    public boolean deposit(double amount) { // deposit method
        if (amount > 0) { // if money is being deposited, add to balance
            this.balance += amount;
            this.notificationService.sendNotification("Amount of " + amount + " TL has been deposited into account " + getAccountNo() + ". Current balance: " + getBalance() + " TL");
            return true;
